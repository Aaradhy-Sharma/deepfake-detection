...
for i in range(NUM_TESTS):
    ...
    print(f"Real image {i}: {real_result}")
    print(f"Fake image {i}: {fake_result}")
...
print(f"Correctly detected {real_count} out of {NUM_TESTS} real images.")
print(f"Correctly detected {fake_count} out of {NUM_TESTS} fake images.")